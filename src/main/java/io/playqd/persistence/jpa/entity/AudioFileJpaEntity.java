...
public class AudioFileJpaEntity extends PersistableAuditableEntity implements AudioFile {
  ...
  public static final String COL_FILE_ADDED_TO_WATCH_FOLDER_DATE = "file_added_to_watch_folder_date";
  ...
  public static final String COL_SPOTIFY_ALBUM_ID = "spotify_album_id";
  ...
  public static final Set<String> METADATA_UPDATABLE_COLUMNS = Set.of(
      ...
      COL_ALBUM_NAME, COL_ALBUM_RELEASE_DATE, COL_TRACK_NAME, COL_TRACK_NUMBER, COL_ARTWORK_EMBEDDED, COL_MB_ARTIST_ID,
      COL_MB_RELEASE_GROUP_ID, COL_MB_RELEASE_TYPE, COL_COMMENT, COL_LYRICS, COL_GENRE);
  ...
  @Column(name = COL_FILE_ADDED_TO_WATCH_FOLDER_DATE)
  private LocalDate fileAddedToWatchFolderDate;
  ...
  @Column(name = COL_SPOTIFY_ALBUM_ID)
  private String spotifyAlbumId;

  @Column(name = COL_SPOTIFY_TRACK_ID)
