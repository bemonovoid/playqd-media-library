...
@Entity
@Table(name = MusicDirectoryInfoEntity.TABLE_NAME)
public class MusicDirectoryInfoEntity extends PersistableAuditableEntity {

  static final String TABLE_NAME = "music_directory_info";
